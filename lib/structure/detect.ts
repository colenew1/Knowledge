...
Row/column indexes are 0-based and refer to the snapshot above.

Identify one or more "regions". Each region describes a contiguous vertical range of Q&A rows in a specific pair of (question_col, answer_col). start_row and end_row are the first and last rows (inclusive) containing actual questions — skip header rows and trailing blanks.
