      ...
      {draft && draft.verdict === 'no_info' && (
        <section className="rounded-lg border border-stone-200 bg-white p-6">
          ...
          <p className="mt-3 text-sm text-stone-600">
            ...
            best-effort answer. The draft will be flagged as inferred and
            every source used will be cited. A reviewer should still
            validate the response before it is sent to a prospect.
          </p>
          <div className="mt-4">
            <button
        ...
        <section className="rounded-lg border border-stone-200 bg-white p-6">
          ...
          {draft.mode === 'infer' && (
            <p className="mt-3 text-xs text-stone-600">
              ...
              material in the knowledge base. It is not a direct quote from
